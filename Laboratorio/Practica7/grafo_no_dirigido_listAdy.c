...
struct Graph* createGraph(struct Edge edges[], int n)
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        // 1. asignar un nuevo nodo de lista de adyacencia de src a dest
        ...
        // 2. asignar un nuevo nodo de lista de adyacencia de `dest` a `src`
        ...
        // cambia el puntero principal para que apunte al nuevo nodo
